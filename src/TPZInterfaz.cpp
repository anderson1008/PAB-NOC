...
//************************************************************************
// By Anderson
void TPZInterfaz :: setPG (Boolean val, PGMsgType msgType)
{
	if( m_Ports)
   {
      (*m_Ports)->setPG(val,msgType);
   }
}

Boolean TPZInterfaz :: getPG(PGMsgType msgType)
{
	if( m_Ports)
   {
      (*m_Ports)->getPG(msgType);
   }
}

void TPZInterfaz :: updatePG(unsigned interfaz, unsigned canal)
{
	getOwner()->updatePG( interfaz, canal);
}

/*
void TPZInterfaz :: setWU (Boolean WU)
{
	if( m_Ports)
   {
      (*m_Ports)->setWU(WU);
...
void TPZInterfaz :: updateWU(unsigned interfaz, unsigned canal)
{
	getOwner()->updateWU( interfaz, canal);
}


void TPZInterfaz :: setACK (Boolean ACK)
{
	if( m_Ports)
   {
      (*m_Ports)->setACK(ACK);
...
void TPZInterfaz :: updateACK(unsigned interfaz, unsigned canal)
{
	getOwner()->updateACK( interfaz, canal);
}
*/
// end Anderson
//************************************************************************
