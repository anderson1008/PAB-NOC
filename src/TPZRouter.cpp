...
void TPZRouter::run(uTIME runTime) {
    ...
    // ********************** By Anderson ******************** //
    // The idea here is to fetch all the components and run at "runtime" one at a time.
    // Then fetch all the connection and run at "runtime" individually.
    // run() is an abstract function.
