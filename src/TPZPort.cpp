...
//************************************************************************
// By Anderson
void TPZPort :: setPG (Boolean val, PGMsgType msgType)
{
   switch (msgType)
   {
      case PG: m_PGStatus = val;
         break;
      case WU: m_WUStatus = val;
         break;
      case ACK: m_ACKStatus = val;
         break;

      default: cout << "TPZPort::SetPG has unknown type." << endl;
         break;
   }

}

Boolean TPZPort :: getPG(PGMsgType msgType)
{
   switch (msgType)
   {
      case PG:
      ...
      default: cout << "TPZPort :: getPG has unknown type." << endl;
         break;
   }
