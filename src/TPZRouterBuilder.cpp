...
// A: I guess this function will be called each time a component is constructed.                                                          INDEX& index )
{
   ...
   {
      // A: although newFrom is a Private Member Function of Class "TPZSimpleRouter",
      //    TPZRouterBuilder is a friend class of TPZSimpleRouter
      //    newFrom can be called without an instance of class TPZSimpleRouter
