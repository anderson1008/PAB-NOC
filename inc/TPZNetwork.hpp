...
//*************************************************************************
   ...
   public:
      ...
      typedef enum { BufferWrite, BufferRead, VCArbitration, SWArbitration, SWTraversal, IStageTraversal,
                     OStageTraversal, MPTraversal, LinkTraversal, RouterBypass, DCSleepSum, PGEpochCount, DCWakeup, PGStage1, PGStage2, PGStage3, Silver} TPZTipoEvento;
     ...
     // }
      ...
      double incrPGCyleSumOfSuqare(double x)
      {
         m_PGSumOfSquare = m_PGSumOfSquare + x;
      }
      double getPGSumOfSquare (void)
      {
   ...
   private:
      ...
      double  m_DCSleepSum;
      double  m_DCWakeup;
      double  m_PGEpoch; // number of epoch a DC is power gated.
      double  m_PGStage1; //
      double  m_PGStage2; //
      double  m_PGStage3; //
