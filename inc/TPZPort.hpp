...
//************************************************************************
   ...
   #endif
   enum PGMsgType {UNKNOWN=0, PG, WU, ACK};
...
//************************************************************************
   ...
   public:
      ...
      //************************************************************************
      // By Anderson
      void setPG (Boolean val, PGMsgType msgType);
		Boolean getPG(PGMsgType msgType);
      // end Anderson
      //************************************************************************
   ...
   protected:
      ...
      Boolean				m_PGStatus; // by Anderson
      Boolean				m_WUStatus; // by Anderson
      Boolean				m_ACKStatus; // by Anderson
